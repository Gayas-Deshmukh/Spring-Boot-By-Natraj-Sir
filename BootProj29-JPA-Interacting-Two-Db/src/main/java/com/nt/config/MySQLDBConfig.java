...
public class MySQLDBConfig 
{
	...
	@Bean("mysqlEMF")
	public LocalContainerEntityManagerFactoryBean createMySqlEntityManagerFactoryBean(EntityManagerFactoryBuilder entityMangFactoryBuilder)
	{
		...
		return entityMangFactoryBuilder.dataSource(createMySqlDS())   		 // datasourse
