...
public class EmployeeOperationController
{
	...
	@PostMapping("/add-emp")
	public String saveEmployee(@ModelAttribute("emp") Employee emp, RedirectAttributes attribs, BindingResult errors)
	{
	...
	@PostMapping("/edit")
	public String editEmployeeFormPage(@ModelAttribute("emp") Employee emp, RedirectAttributes attribs, BindingResult errors)
	{
		if (emp.getVFlag().equalsIgnoreCase("no"))
		{
			if (empValidator.supports(Employee.class))
