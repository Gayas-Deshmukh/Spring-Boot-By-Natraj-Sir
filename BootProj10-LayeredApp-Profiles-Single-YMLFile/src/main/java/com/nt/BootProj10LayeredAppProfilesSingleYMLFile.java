...
public class BootProj10LayeredAppProfilesSingleYMLFile 
{
	public static void main(String[] args) 
	{
		ConfigurableApplicationContext context = SpringApplication.run(BootProj10LayeredAppProfilesSingleYMLFile.class, args);
